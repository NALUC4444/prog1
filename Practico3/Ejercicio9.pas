...
begin
    ...
    write('El numero es: ');
    write(dg1, PUNTO, dg2, dg3, dg4);
end.

{No hay que comprobar que se ingresen cuatro numeros, dado por letra:
"Su programa no necesita controlar que el entero
ingresado tenga hasta cuatro cifras, asuma que ası sera."}